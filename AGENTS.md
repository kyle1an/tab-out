...
> 8. **Filter shortcut:** assign **"Open Tab Out with the filter focused"** in `chrome://extensions/shortcuts` to focus the current Tab Out filter, or open a fresh Tab Out page with the filter ready for typing.
