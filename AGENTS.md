...
- Within each rendered domain card, known chips keep their effective-URL order across refreshes; title/loading/favIcon changes update the chip in place instead of re-sorting existing chips.
