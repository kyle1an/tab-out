    ...
    >
      <div
        className={cn(
          ...
          !isFolded && 'clickable cursor-default hover:bg-[rgba(82,82,82,0.075)] [&:has(.chip-actions):hover::after]:opacity-100 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--accent-amber)]',
          chip.activeInOtherWindow && 'bg-[rgba(82,82,82,0.075)] text-tab-ink shadow-[0_1px_2px_rgba(10,10,10,0.04)]',
          chip.activeInOtherWindow && !isFolded && 'hover:bg-[rgba(82,82,82,0.13)]',
