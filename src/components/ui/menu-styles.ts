...
export const destructiveMenuItemClassName =
  'text-destructive data-disabled:bg-transparent! data-disabled:text-muted-foreground! data-highlighted:bg-destructive/10 data-highlighted:text-destructive'
