...
- Clicking a same-title **Page Chip** group's merged title or blank non-URL surface activates a default distinguisher: active in the current window first, then active in another window, then the first visible variant.
