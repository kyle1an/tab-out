...
test('PageChip renders same-title URL variants below one visible title', () => {
  ...
  assert.match(pageChipSource, /function onVariantGroupChipMouseEnter\(e: MouseEvent<HTMLDivElement>\)[\s\S]*?titleVariantEventTargetsExactVariant\(e\.target\)[\s\S]*?previewDefaultTitleVariant\(\)/)
  ...
  assert.match(pageChipSource, /function onTitleVariantMouseLeave\(e: MouseEvent<HTMLElement>\)[\s\S]*?closest\('\.page-chip'\)[\s\S]*?!titleVariantEventTargetsExactVariant\(e\.relatedTarget\)[\s\S]*?previewDefaultTitleVariant\(\)/)
  ...
  assert.match(pageChipSource, /const variantGroupInteractionProps = isTitleVariantGroup[\s\S]*?onClick: onVariantGroupChipClick[\s\S]*?onMouseDown: onVariantGroupChipMouseDown[\s\S]*?onMouseEnter: onVariantGroupChipMouseEnter[\s\S]*?onMouseLeave: onVariantGroupChipMouseLeave/)
