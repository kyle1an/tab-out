...
test('PageChip hover fade appears and clears without its own transition lag', () => {
  ...
  assert.ok(chipMatch, 'page chip should render')
  assert.match(chipMatch[1], /\bhover:bg-\[rgba\(82,82,82,0\.08\)\]/)
...
test('PageChip expands same-title URL variant groups in place', () => {
  ...
  assert.match(pageChipSource, /shadow-\[0_4px_14px_rgba\(10,10,10,0\.07\)\]/)
  ...
  assert.match(pageChipSource, /backgroundColor: 'var\(--chip-hover-fade-bg\)'/)
...
test('PageChip routes saved-page mutation actions through Base UI context menus', () => {
  ...
  assert.match(pageChipSource, /\[\&\.page-chip-context-menu-open\]:bg-\[rgba\(82,82,82,0\.08\)\]/)
  assert.match(pageChipSource, /\[\&\.page-chip-tooltip-open\]:bg-\[rgba\(82,82,82,0\.08\)\]/)
...
test('TabHistoryPanel uses PageChip-style fade truncation and in-place title expansion', () => {
  ...
  assert.match(tabHistoryPanelSource, /\[\&\.history-entry-expanded-open\]:bg-\[color-mix\(in_srgb,var\(--card-bg\)_87%,rgb\(82_82_82\)\)\]/)
  assert.match(tabHistoryPanelSource, /\[\&\.history-entry-expanded-open\]:bg-\[color-mix\(in_srgb,var\(--card-bg\)_82%,rgb\(82_82_82\)\)\]/)
  ...
  assert.match(tabHistoryPanelSource, /shadow-\[0_4px_14px_rgba\(10,10,10,0\.07\)\]/)
...
test('PageChip renders folded titles before env controls', () => {
  ...
  assert.match(chipMatch[1], /page-chip-tooltip-open\]:bg-\[rgba\(82,82,82,0\.05\)\]/)
