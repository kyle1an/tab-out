...
test('TabHistoryPanel uses PageChip-style fade truncation and in-place title expansion', () => {
  ...
  assert.match(tabHistoryPanelSource, /history-entry-scrollbar pointer-events-none absolute top-0 right-0 bottom-0 z-0/)
  assert.match(tabHistoryPanelSource, /history-entry-scrollbar-thumb/)
