...
test('extension HTML loads the Vite-built React entry', () => {
  ...
  const uiFiles = readdirSync('src/components/ui')
  ...
  assert.match(buttonSource, /unstyled: ''/)
  ...
  assert.match(tabsSource, /TabsIndicator/)
  ...
  assert.match(headerBarSource, /from '\.\/ui\/button'/)
  assert.match(headerBarSource, /from '\.\/ui\/input'/)
  assert.match(headerBarSource, /from '\.\/ui\/tabs'/)
  assert.doesNotMatch(headerBarSource, /TextInput|SegmentedTabs/)
  assert.equal(uiFiles.includes('Button.tsx'), false)
  assert.equal(uiFiles.includes('TextInput.tsx'), false)
  assert.equal(uiFiles.includes('SegmentedTabs.tsx'), false)
