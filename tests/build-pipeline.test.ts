...
test('extension HTML loads the Vite-built React entry', () => {
  ...
  assert.match(pageChipSource, /chipTooltipContent = chip\.iconOnly \|\| isTextTruncated \? chip\.tooltip : undefined/)
  assert.match(pageChipSource, /<TooltipAnchor content=\{chipTooltipContent\}>/)
