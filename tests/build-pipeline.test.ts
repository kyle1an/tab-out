...
test('extension HTML loads the Vite-built React entry', () => {
  ...
  assert.match(pageChipSource, /width: Math\.min\(maxWidth, Math\.max\(minWidth, contentMetrics\.width \+ horizontalInset\)\)/)
  ...
  assert.match(pageChipSource, /!shouldExpandChip && 'hover:bg-\[rgba\(82,82,82,0\.08\)\]/)
  assert.match(pageChipSource, /shouldExpandChip && '\[\&\.page-chip-tooltip-open\]:bg-\[rgba\(82,82,82,0\.08\)\]/)
  ...
  assert.match(pageChipSource, /color-mix\(in srgb, var\(--card-bg\) 92%, rgb\(82 82 82\)\)/)
