...
test('extension HTML loads the Vite-built React entry', () => {
  ...
  assert.match(tabHistoryPanelSource, /function getHistoryEntryExpansionGeometry\(entryEl: HTMLElement \| null, titleEl: HTMLElement \| null, panelEl: HTMLElement \| null = null\)/)
