...
test('extension HTML loads the Vite-built React entry', () => {
  ...
  assert.match(tooltipSource, /popupElement\.addEventListener\('wheel', handleContentWheel, \{\s*passive: false\s*\}\)/)
  assert.match(tooltipSource, /popupElement\.removeEventListener\('wheel', handleContentWheel\)/)
