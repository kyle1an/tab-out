...
test('extension HTML loads the Vite-built React entry', () => {
  ...
  assert.match(pageChipSource, /const layoutEl = titleTextEl \|\| textEl/)
  assert.match(pageChipSource, /Math\.round\(rect\.top \* 100\) \/ 100/)
  ...
  assert.match(tabHistoryPanelSource, /function historyTitleTooltipLayoutCacheKey\(titleEl: HTMLElement\)[\s\S]*Math\.round\(rect\.top \* 100\) \/ 100/)
